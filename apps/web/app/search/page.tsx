    ...
    <Section>
      <Container>
        <div className="mb-8 max-w-2xl">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">Discover names that fit your family.</h1>
        </div>

        <div className="mb-10 rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-sm">
          {/* interactive client-side search */}
          {/* @ts-expect-error Server -> Client prop serializing NameRecord[] is OK */}
          <NameSearch
            initialNames={names}
            initialQuery={q}
